...
cd /home/dn/amd-dev/amd/amd-anp && sudo rm -rf build &&sudo make RCCL_HOME=/home/dn/amd-dev/amd/rccl/ MPI_INCLUDE=/opt/ompi-4.1.6/include/ MPI_LIB_PATH=/opt/ompi-4.1.6/lib/ ROCM_PATH=/opt/rocm-7.0.1/
