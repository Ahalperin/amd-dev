...
/home/amir/amd-dev/dn/rccl-tests/build/all_reduce_perf -b 1M -e 16G -f 2 -g 1 -n 20 -c 1 -w 5
...
-x NCCL_DEBUG=VERSION \
-x NCCL_DEBUG_FILE=nccl_debug.log \
/home/dn/amd-dev/dn/rccl-tests/build/all_reduce_perf -b 1M -e 16G -f 2 -g 1 -n 20 -c 1 -w 5
